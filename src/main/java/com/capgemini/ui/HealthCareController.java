...
public class HealthCareController {
	...
	public static void main(String[] args) throws IOException {
		...
		//"si" is used as the Instance variable of "ServiceImplementation" throughout the class
		Validation v = new Validation();
		//"v" is used as the Instance variable of "Validation" throughout the class
