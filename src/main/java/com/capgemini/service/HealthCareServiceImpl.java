...
public class HealthCareServiceImpl implements HealthCareService {
	...
	//"hcdi" is used for "Health Care Dao Implementation" throughout the class
	...
	{
		return hcdi.removeTest(center,test);//calling the removeTest method of the HealthCareDaoImpl class that interacts with the Test arrayList.
	}
	...
	{
		hcdi.viewCenterRepectiveTests(centerId); //calling the viewCenterRespectiveTests method of the HealthCareDaoImpl class that interacts with the DiagnosticCenter arrayList.
	}
